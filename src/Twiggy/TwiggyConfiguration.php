...
class TwiggyConfiguration implements ArrayAccess
{
    /**
     * @var mixed[]
     */
    ...
    const MIGRATION_TABLE_KEY = 'tableName';
    ...
    private static $defaultValues = [
        ...
        self::MIGRATION_TABLE_KEY => 'migrations',
        self::MIGRATION_DIRECTORY => 'migration',
